...
public class HuffmanTests {
    ...
    public void decom_t5() {
        Huffman h = new Huffman("AAAAB");
        // byte 0: 0000 0100 = 4 (message length = 4)
        // byte 1: 1111 0000 = -16
        byte[] compressed = {5, -16};
        assertEquals("AAAAB", h.decompress(compressed));
    }
    
    @Test
    public void decom_t6() {
        Huffman h = new Huffman("AAAABC");
        // byte 0: 0000 0100 = 4 (message length = 4)
        // byte 1: 0000 1011 = -16
        byte[] compressed = {6, -15};
        assertEquals("AAAABC", h.decompress(compressed));
    }
}
